...
export function seedState(): AppState {
  return {
    ...
    startupItems: [
      ...
      { id: 'si-sol', categoryId: 'sc-cafe', unit: 'cafe', name: 'Solicitor fees', category: 'Legal', newPrice: 8000, usedPrice: null, condition: 'new', notes: 'GST-ex professional fees, QLD retail lease review + limited negotiation. Form-12-only $1,395 inc GST (Queensland Legal). SHA is a separate line.', supplier: 'Astris Law / Qld Legal', url: '', excludeFromContingency: false, final: false },
      { id: 'si-sha', categoryId: 'sc-cafe', unit: 'cafe', name: 'Shareholders / partnership agreement', category: 'Legal', newPrice: 2500, usedPrice: null, condition: 'new', notes: 'Sprintlaw SHA from $1,200+GST ($1,320); partnership agreement from $1,100+GST. Astris company+SHA $3,500–$8,000. Mid $2,500. Dashboard seed ownership is 70/30 Partner A (Small) / Partner B (Sudy).', supplier: 'Sprintlaw SHA', url: '', excludeFromContingency: false, final: false },
      ...
      { id: 'si-coffee', categoryId: 'sc-cafe', unit: 'cafe', name: 'Coffee equipment (machine + grinders)', category: 'Equipment', newPrice: 16000, usedPrice: null, condition: 'new', notes: '', supplier: '', url: '', excludeFromContingency: false, final: false },
      { id: 'si-kit', categoryId: 'sc-cafe', unit: 'cafe', name: 'Kitchen equipment', category: 'Equipment', newPrice: 29000, usedPrice: null, condition: 'new', notes: 'Mid BOM ~$28,827 inc GST: Panasonic NE-1853, Turbofan E27M3, FED-X fridge/freezer, Bonvue SL830V, Roband press, Washtech XG, milk fridge, pie warmer, slicer, ice.', supplier: 'Reward / Leading Catering / Stellar', url: '', excludeFromContingency: false, final: false },
